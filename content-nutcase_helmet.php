...
<article <?php post_class('product-single'); ?>>
	<div class="container">
		...
		<div class="entry-content product-content">
			...
			<?php endif; ?>
			<a href="<?php echo esc_url( get_permalink( get_page_by_path( __( 'Find A Retailer','nutcase' ) ) ) ); ?>" class="btn"><?php _e('Find a dealer', 'nutcase'); ?></a>
		</div>
	</div>
</article>
<?php // feature loop
		...
		<div class="col-group">
			<div class="col1of2">
				<div class="video">
					 ...
					 <?php get_template_part( 'content', 'nutcase_fit-video' ); ?>
				</div>
			</div>
			<div class="col1of2">
